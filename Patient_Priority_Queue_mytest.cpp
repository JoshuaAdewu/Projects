...
int main() {
  ...
  /*std::cout << "Test with large Queue" << std::endl;
  const int NUM = 1000;
  int count = 0;
  while(count < NUM){
    queue5.insertPatient(patient1);
    queue5.insertPatient(patient2);
    queue5.insertPatient(patient3);
    queue5.insertPatient(patient4);
    queue5.insertPatient(patient5);
    queue5.insertPatient(patient6);
    count++;
  }
